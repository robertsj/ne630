...
% Solution cue: ask for syllabus questions, introduce the text and homework
...
% Solution cue: ask what each term in E=mc^2 means before the algebra;
...
% Solution cue: distinguish energy density from power density and close by
