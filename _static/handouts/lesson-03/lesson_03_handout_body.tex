...
\end{align*}
\normalsize
Delayed neutron energies are typically
\RevealBlank[0.80in]{}.  
Deposited $\beta$ and $\gamma$ energy
...
\[
 \frac{N(nt_{1/2})}{N_0}=\MathBlank[0.72in]{},
 \qquad
 \frac{A(nt_{1/2})}{A_0}=\MathBlank[0.72in]{}.
\]
...
\[
 \begin{aligned}
 A(t)&=\MathBlank[1.30in]{},\\[-2pt]
 N_{\mathrm{sat}}&=\MathBlank[0.60in]{},\qquad
 A_{\mathrm{sat}}=\MathBlank[0.46in]{}.
 \end{aligned}
\]
...
At $t=1\unit{h}$,
\[
 \frac{N_{\mathrm{Sr}}}{N_0}=\MathBlank[0.52in]{},\quad
 \frac{N_{\mathrm{Y}}}{N_0}=\MathBlank[0.52in]{},\quad
 \frac{N_{\mathrm{Zr}}}{N_0}=\MathBlank[0.52in]{}.
\]
...
\[
 A_2(t)\approx\MathBlank[0.66in]{},
 \qquad
 \frac{N_2}{N_1}\approx\MathBlank[0.82in]{}.
\]
