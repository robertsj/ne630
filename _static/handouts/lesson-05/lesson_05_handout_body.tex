...
Elastic scattering removes a neutron from the original beam: \RevealBlank[0.48in]{}.
It destroys that neutron: \RevealBlank[0.48in]{}.  Which listed reactions can
...
A spectrum $\phi(E)$ describes \RevealBlank[1.25in]{} at
energy $E$; a cross section $\sigma_x^i(E)$ describes
\RevealBlank[1.45in]{} for nuclide $i$ and channel $x$.
\end{checkpoint}
...
\begin{align*}
 ...
 \frac{R_x^i}{R_t^i}
   &: \text{reaction is }\RevealBlank[0.36in]{}\text{, given target }i,\\[2pt]
 \frac{R_x^i}{R_x}
   &: \text{target is }\RevealBlank[0.36in]{}\text{, given reaction }x,\\[2pt]
 \frac{R_f}{R_a}
   &: \text{an absorption produces }\RevealBlank[0.58in]{}.
\end{align*}
...
\begin{align*}
 \frac{R_e}{n_0\phi_0}
   &=2(20)+1(4)+1(15)=\MathBlank[0.56in]{}\unit{b},\\
 \frac{R_a}{n_0\phi_0}
   &=2(0.1)+1(100+500)=\MathBlank[0.66in]{}\unit{b},\\
 \frac{R_t}{n_0\phi_0}
   &=\MathBlank[0.54in]{}+\MathBlank[0.66in]{}
     =\MathBlank[0.66in]{}\unit{b}.
\end{align*}
\normalsize
\end{boardbox}
...
\begin{align*}
 P(e\mid\mathrm{int})
   &=\frac{59}{659.2}=\MathBlank[0.60in]{}\approx\RevealBlank[0.44in]{},\\
 P(\mathrm{H\ elastic}\mid\mathrm{int})
   &=\frac{2(20)}{659.2}=\MathBlank[0.60in]{}\approx\RevealBlank[0.44in]{},\\
 P(\mathrm{U\ absorption}\mid\mathrm{int})
   &=\frac{100+500}{659.2}=\MathBlank[0.60in]{}\approx\RevealBlank[0.44in]{},\\
 P(f\mid\mathrm{absorbed})
   &=\frac{500}{600.2}=\MathBlank[0.60in]{}\approx\RevealBlank[0.44in]{}.
\end{align*}
\normalsize
\end{checkpoint}
...
\RevealBlank[1.08in]{}, form reaction rates, then normalize
