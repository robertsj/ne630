...
\providecommand{\LessonEightPureFuelSketch}{\begin{tikzpicture}[x=.88cm,y=.76cm,>=Latex,font=\scriptsize,
...
\end{tikzpicture}}
\providecommand{\LessonEightMixtureSketch}{\begin{tikzpicture}[x=.85cm,y=.73cm,>=Latex,font=\scriptsize,
                   line cap=round,line join=round]
