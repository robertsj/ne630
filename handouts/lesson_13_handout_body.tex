...
\begin{align*}
 \phi_1&=\MathBlank[1.30in]{s_1/\Sigma_{r,1}},\\
 \phi_2&=\MathBlank[1.75in]{\Sigma_{s,2\gets1}\phi_1/\Sigma_{r,2}},\\
...
\midrule
$g=1$ (fast) & $0$\\
$g=2$ (intermediate) & \MathBlank[1.10in]{18.26284}\\
$g=3$ (thermal) & \MathBlank[1.10in]{1.73542}\\
\bottomrule
\end{tabularx}
\end{boardbox}
...
\[
 ...
 =\MathBlank[0.95in]{0.00173716}\unit{b}.
\]
Hence
\[
