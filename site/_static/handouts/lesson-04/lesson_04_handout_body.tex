...
\[
 (a)\ \RevealBlank[0.54in]{}
 \qquad
 (b)\ \RevealBlank[0.54in]{}
\]
\end{checkpoint}
...
\[
 n_{\mathrm{Al}}=\MathBlank[1.30in]{}
 \unit{Al\ atoms/cm^3}.
\]
\textbf{Water:} $\rho=1.00\unit{g/cm^3}$, $M=18.015\unit{g/mol}$,
\[
 \begin{aligned}
 n_{\mathrm{H_2O}}&=\MathBlank[1.22in]{}
   \unit{molecules/cm^3},\\
...
\[
 ...
 =\MathBlank[1.00in]{}
 \equiv\Sigma\,\Delta x,
 \qquad \boxed{\Sigma=\MathBlank[0.72in]{}}.
\]
...
\[
 \boxed{\frac{dI}{dx}=\MathBlank[0.88in]{}}
 \quad\Longrightarrow\quad
 \boxed{I(x)=\MathBlank[1.12in]{}}.
\]
\end{boardbox}
...
\RevealBlank[0.62in]{}, not \RevealBlank[0.62in]{}.
\normalsize
\end{fixedbox}
...
\[
 P(X>\ell)=\MathBlank[0.70in]{}=
 \RevealBlank[0.70in]{},
\]
and the fraction having collided is
\[
 P(X\le\ell)=\MathBlank[0.84in]{}=
 \RevealBlank[0.70in]{}.
\]
...
\[
 \int_0^\infty p_X(x)\,dx=\MathBlank[0.48in]{},
 \qquad [p_X]=\MathBlank[0.72in]{}.
\]
...
\[
 ...
 =\MathBlank[1.18in]{}.
\]
In vacuum this becomes \RevealBlank[0.48in]{}. Which attenuation remains,
...
For water, $n_{\mathrm H}:n_{\mathrm O}=\MathBlank[0.45in]{}$ and
...
\midrule
${}^{235}$U & $4.00\unit{g}$ & \RevealBlank[0.72in]{}\\
${}^{238}$U & $96.00\unit{g}$ & \RevealBlank[0.72in]{}\\
\bottomrule
\end{tabularx}
\normalsize
\[
 e_a=\MathBlank[0.90in]{}
 =\RevealBlank[0.76in]{}.
\]
