% Lesson 07: shared student/instructor board-supported handout.
...
\IfFileExists{figures/u238_threshold.pdf}{%
  \includegraphics[width=\linewidth,height=1.30in,keepaspectratio]{figures/u238_threshold.pdf}%
}{%
  {\sffamily\small\color{KSUGray}Review figure unavailable.\par}
  \vspace{6pt}
...
p_Y(y)=\left|\frac{dx}{dy}\right|p_X(x)
  =\MathBlank[0.55in]{\frac12}.
\]
Support of $Y$: \RevealBlank[1.20in]{$-1\leq y\leq1$}; $p_Y(y)=0$ otherwise.
\end{checkpoint}
...
\overline{E'}=\Expect[E'\mid E]=
  \MathBlank[1.35in]{\frac12(1+\alpha)E}.
\]
\RuledLines{2}
\end{checkpoint}
