...
{\bf Example}. Suppose the {\bf shutdown margin} is -0.02\%.  What is the multiplication factor of the shutdown reactor?\\
{\small {\bf Ans.} }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Beyond Xe!}
 
Although  ${}^{135}$Xe is most important (and the only one that strongly impacts reactor dynamics) other strongly absorbing fission products include 
\begin{itemize}
 \item ${}^{149}$Sm (see FNRP for a discussion), ${}^{147}$Sm
 \item ${}^{133}$Cs
 \item ${}^{147}$Nd, ${}^{143}$Nd
 \item ${}^{103}$Rh
\end{itemize}

For full production/decay chains of important fission products, 
see \url{https://www-nds.iaea.org/wimsd/fpbchains.htm}
\end{frame}
